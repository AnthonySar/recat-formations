...
const Svg = (props) => {
  ...
  return(
    <div>
      <svg version="1.0" id="Layer_1" xmlns="http://www.w3.org/2000/svg" width="80px" height="80px" viewBox="0 0 64 64">
        <path fill={props.color} d="M60,28c0-8.301-5.016-24-24-24h-8C9.016,4,4,19.699,4,28c-2.211,0-4,1.789-4,4v16c0,2.211,1.789,4,4,4h4v4
